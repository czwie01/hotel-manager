...
import rooms.domain.events.MiniBarFromRoomRemovedEvent;
import rooms.domain.events.MiniBarToRoomAddedEvent;
import rooms.domain.events.RoomCreatedEvent;
import rooms.domain.events.RoomRemovedEvent;
import rooms.domain.events.RoomTypeUpdatedEvent;
